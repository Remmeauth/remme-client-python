...
_EMPTYPAYLOAD = _descriptor.Descriptor(
  name='EmptyPayload',
  full_name='EmptyPayload',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
DESCRIPTOR.message_types_by_name['EmptyPayload'] = _EMPTYPAYLOAD
...
EmptyPayload = _reflection.GeneratedProtocolMessageType('EmptyPayload', (_message.Message,), dict(
  DESCRIPTOR = _EMPTYPAYLOAD,
  __module__ = 'transaction_pb2'
  # @@protoc_insertion_point(class_scope:EmptyPayload)
  ))
_sym_db.RegisterMessage(EmptyPayload)
