...
class RemmeAccount(ECDSA):
    ...
    def __init__(self, private_key_hex=None, type_=None):
        """
        ...
        Args:
            ...
            type_ (enum): account type (user, node)
        ...
        type_ = type_ if type_ else AccountType.USER.value
        ...
        is_user = type_ == AccountType.USER
