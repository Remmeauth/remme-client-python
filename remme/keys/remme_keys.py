...
class RemmeKeys(IRemmeKeys):
    ...
    def __init__(self, key_type=KeyType.RSA, private_key=None, public_key=None):
        ...
        keys = RemmeKeys(KeyType.RSA, private_key)  # Our chain works only with RSA now
        ```
        ...
        keys = RemmeKeys(KeyType.RSA, public_key)  # Our chain works only with RSA now
        ```
        :param key_type: KeyType
        :param private key for specified key type: string or bytes
        :param public_key for specified key type: string or bytes
        """
    ...
    def generate_key_pair(key_type, options=None):
        ...
        keys = RemmeKeys.genarate_key_pair(KeyType.RSA)  # Our chain works only with RSA now
        ```
        :param key_type: KeyType
    ...
    def get_address_from_public_key(key_type, public_key):
        ...
        address = RemmeKeys.get_address_from_public_key(KeyType.RSA, public_key)  # Our chain works only with RSA now
        ```
        :param key_type: KeyType
    ...
    def get_key_type(self):
        ...
        Return key type.
        """
        return self._keys.key_type.name
    ...
    def get_family_name(self):
        ...
        Return family name.
        """
        return self._keys.family_name.name
